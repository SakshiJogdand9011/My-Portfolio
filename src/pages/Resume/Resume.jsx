    ...
    <section>
      ...
      <div className="timeline">
        ...
        <ol className="timeline-list">
          <TimelineItem
            title="Dr. Babasaheb Ambedkar Technological University, Loner"
            date="2022 — 2025"
            description="Computer Engineering (B.Tech)"
          />
          <TimelineItem
            title="Yashwantrao Chavan Institute of Polytechnic, Beed"
            date="2019 — 2022"
      ...
      <div className="skill">
        ...
        <ul className="skills-list content-card">
          ...
          <SkillItem title="DBMS" value={70} />
          <SkillItem title="Object Oriented Programming" value={90} />
          <SkillItem title="Data Structure" value={50} />
        </ul>
      </div>
    </section>
  );
